    ...
    >
      <div className="relative">
        ...
        >
          <div
            ...
            className={`basis-1/3 flex items-center justify-center py-2 text-xl ${
              iconHover === 1 ? "bg-black text-white" : "text-black"
            }>`}
          >
          ...
          <div
            ...
            onMouseLeave={() => setIconHover(null)}
            className={`basis-1/3 flex items-center justify-center py-2 text-xl border-x border-black/50 ${
              iconHover === 2 ? "bg-black text-white" : "text-black"
            }>}`}
          >
          ...
          <div
            ...
            onMouseLeave={() => setIconHover(null)}
            className={`basis-1/3 flex items-center justify-center py-2 text-xl ${
              iconHover === 3 ? "bg-black text-white" : "text-black"
            }>`}
          >
      ...
      <div className="flex items-center justify-between px-4 bg-gray-100">
        <div className="p-4 space-y-1 ">
          ...
          <MainHeading className="font-semibold text-lg ">
            {name.split("|")[0]}
          </MainHeading>
